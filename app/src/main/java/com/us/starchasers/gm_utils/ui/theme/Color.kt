...
val DarkText = Color(0xFFf6c22e)
val LightText = Color(0xFF9800d5)

val AttackColor = Color(0xFFff4433)
val DefenseColor = Color(0xFF2ce144)
val ComboColor = Color(0xFFFFFFFF)
val UncommonColor = Color(0xFF00ecff)
val MotivatorColor = Color(0xFF74cee0)
val EpicColor = Color(0xFFb270d6)
val LegendaryColor = Color(0xFFff8f00)
val InlineColor = Color(0xFF71c768)
val DarkBorderColor = Color(0xFF95751c)
val LightBorderColor = Color(0xFF6666ee)
